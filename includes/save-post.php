...
function r_save_post_admin( $post_id, $post, $update ){
	...
	$recipe_data                        =   array();
	$recipe_data['ingredients']         =   sanitize_textarea_field( $_POST['r_inputIngredients'] );
	...
	$recipe_data['rating']              =   0; // no admin input 
	$recipe_data['rating_count']        =   0; // no admin input
   // var_dump($recipe_data);die();
